...
// I had trouble with test 14. I kept getting the error "The value of the adam children property should be equal to the value of the terah children property", even though I was sure I had assigned it properly. I had to search online to find that I needed to define terah.children higher on the page before referring to it in adam.
//
//The syntax for altering objects outside of them is pretty straightforward. Once I identified the object.property notation I had no problem.
//
//I learned about the object.property notation, how to delete properties outside of them, and that variables need to be assigned above where they are referenced.
//
